...
var CreateProductPage = function CreateProductPage() {
  ...
  var categoryArray = function categoryArray(e) {
    var value = Array.from(e.target.value, function (option) {
      return option.value;
    });
    console.log(value);
    return value; // if(productCategory.include(cate)){
