...
var CreateProductPage = function CreateProductPage() {
  ...
  var categoryArray = function categoryArray(e) {
    ...
    if (productCategory.include(cate)) {} else {
